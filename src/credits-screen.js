...
CreditsScreen.prototype.show = function (oldState) {
	this.elapsedTime = 0;
	this.shown = true;
	this.creditsFallen = false;
};

CreditsScreen.prototype.hide = function (newState) {
...
CreditsScreen.prototype.update = function (delta) {
...
CreditsScreen.prototype.creditsCollisionCallback = function (credits, ground) {
