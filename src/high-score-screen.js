...
var topOfScreenWallHeight = (windowHeight - groundHeight - 150) / 4;
...
HighScoreScreen.prototype.fallDist = windowHeight - brickHeight;
HighScoreScreen.prototype.boundsToPush = 0;

HighScoreScreen.prototype.playKeyPressed = function () {
    setState(new MainMenu());
};

HighScoreScreen.prototype.show = function (oldState) {
    var menuButtonX = 600;
    var menuButtonY = 40;
    ...
    this.menuButton = game.add.button(menuButtonX, menuButtonY, 'menubutton', this.playKeyPressed, this, 1, 0, 2);
...
HighScoreScreen.prototype.setNewState = function(newState) {
    this.newState = newState;
    this.newState.backdropTween.onComplete.add(this.destroy, this);

}

HighScoreScreen.prototype.hide = function (newState) {
    this.menuButton.inputEnabled = false;
};

HighScoreScreen.prototype.destroy = function() {
...
HighScoreScreen.prototype.render = function () {
};

HighScoreScreen.prototype.makeMiniWall = function (x, lane, height, newRecord) {
